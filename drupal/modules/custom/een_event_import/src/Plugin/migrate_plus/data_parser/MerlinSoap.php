 ...
 * @DataParser(
 *   id = "merlin_soap",
 *   title = @Translation("Merlin SOAP")
 * )
 */
class MerlinSoap extends DataParserPluginBase implements ContainerFactoryPluginInterface {
  ...
  protected function openSourceUrl($url) {
    ...
    $response = $client->{$this->function}(array('request' => $this->parameters));
