...
namespace Drupal\een_opportunity_import\Plugin\migrate_plus\data_parser;
 ...
 * @DataParser(
 *   id = "merlin_xml",
 *   title = @Translation("Merlin XML")
 * )
 */
class MerlinXml extends DataParserPluginBase {
  ...
  protected function openSourceUrl($url) {
    ...
    $this->reader->close();
    return $this->reader->open($url, NULL, NULL);
  }
