...
namespace Drupal\een_salesforce\Plugin\SalesforceMappingField;
 ...
 * )
 */
class EventDate extends SalesforceMappingFieldPluginBase {
  ...
  public function value(EntityInterface $entity, SalesforceMappingInterface $mapping) {
    ...
    // Format the datetime correctly for Salesforce.
