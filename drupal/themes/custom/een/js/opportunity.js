jQuery(function () {
    ...
    $('.contents-list a[href^="#"]').click(function() {
        $('html, body').animate({
    ...
    var stopSelector = document.querySelector("#express_your_interest");
	...
	var viewportWidth = getViewportWidth();
        ...
        var stopPointY = stopPoint.top + scroll;
	...
	function stickySidebar() {
		...
		if(scroll >= sidebarY) {
                    ...
                    if(scroll >= stopPointY - $el.position().top){
                        if (sidebarStyle.position) {
                            
                            
                            sidebarStyle.position = "relative";
                            var bottom = $el.outerHeight(true) - $el.position().top;                             
