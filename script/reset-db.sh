...
mysql ${MYSQL_CONNECTION_ARGS} --execute "GRANT SELECT, UPDATE, INSERT, DELETE, ALTER, CREATE, INDEX, DROP on ${DB}.* to '${MYSQL_APP_USER}'@'%' IDENTIFIED BY '${MYSQL_APP_PASSWORD}';"
